        ...
        <div className="md:flex items-center">
          <div className="mr-4">
            <img
              ...
              alt="Profile"
              className="w-36 h-32 rounded-lg object-cover border border-gray-200"
            />
          </div>
          <div>
            <p className="text-gray-500 text-sm text-start mt-4 md:mt-0">Welcome</p>
            <h2 className="text-blue-600 font-medium text-xl text-start">Ahmed Ali</h2>
            <p className="text-gray-700 text-sm mt-1 text-start">{user?.phone}</p>
